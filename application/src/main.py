...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        hdr.setSectionResizeMode(self.Columns.PREF, QHeaderView.Stretch)
        hdr.setSectionResizeMode(self.Columns.EXISTS, QHeaderView.ResizeToContents)
        self.table.setColumnWidth(self.Columns.EXEC, 420)
        self.table.setColumnWidth(self.Columns.PREF, 220)
        self.table.setColumnWidth(self.Columns.EXISTS, 80)
